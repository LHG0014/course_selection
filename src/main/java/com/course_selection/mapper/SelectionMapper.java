...
public interface SelectionMapper {
    ...
    @Insert("insert into selection_information ( id, sid, eid, ename, weeknum, day, section, lab ,seat) values( null, #{sid}, #{eid}, #{ename}, #{weeknum}, #{day}, #{section}, #{lab} ,#{seat})")
    public void add(@Param("sid") int sid, @Param("eid") int eid, @Param("ename") String ename, @Param("weeknum") int weeknum, @Param("day") int day, @Param("section") int section, @Param("lab") int lab, @Param("seat") int seat);
